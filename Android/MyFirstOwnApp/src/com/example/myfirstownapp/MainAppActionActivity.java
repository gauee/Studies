...
import com.example.myfirstownapp.services.AppConnection;
import com.example.myfirstownapp.services.SshConnection;
...
public class MainAppActionActivity extends Activity {
	...
	public void onSwitchWindow(View view){
		Log.d("debug","onSwitchWindow");
		sendMsg(AppConnection.EXEC_SWITCH_WINDOW);
	}
	...
	public void onEndSwitchWindow(View view){
		Log.d("debug","onEndSwitchWindow");
		sendMsg(AppConnection.EXEC_END_SWITCH_WINDOW);
	}
